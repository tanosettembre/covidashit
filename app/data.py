...
from settings import (
    VERSION, NEW_POSITIVE_KEY, TOTAL_CASES_KEY, VAX_FIRST_DOSE_KEY,
    VAX_SECOND_DOSE_KEY, HEALTHCARE_PERS_KEY, NONHEALTHCARE_PERS_KEY,
...
from settings.vars import (
    DAILY_POSITIVITY_INDEX, REGION_KEY, PROVINCE_KEY, VAX_LATEST_UPDATE_KEY,
    VAX_DATE_FMT, CHART_DATE_FMT, UPDATE_FMT, VAX_UPDATE_FMT, DATE_KEY,
    NOTE_KEY, VAX_DATE_KEY, VAX_AREA_KEY, VAX_AGE_KEY, POP_KEY,
    ADMINS_DOSES_KEY, DELIVERED_DOSES_KEY, VAX_ADMINS_PERC_KEY,
    VAX_TOT_ADMINS_KEY, VAX_PROVIDER_KEY
)
...
NON_CUM_QUANTITIES = [
    qty for qty in VARS_CONF if VARS_CONF[qty]["type"] == "current"
]
DAILY_QUANTITIES = [
    qty for qty in VARS_CONF if VARS_CONF[qty]["type"] == "daily"
]
TREND_CARDS = [
